/*
[DIRSCRIBE]
Summarizes code files in a directory based on CLI arguments. Supports filtering by file extensions, excluding/including paths, and keyword matching. Outputs the summary to a file or clipboard.
