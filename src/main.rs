/*
[DIRSCRIBE]
Summarizes code files in a directory, applies templates, and outputs to file or clipboard. Handles Git commits, file extensions, include/exclude paths, and keyword filtering.
...
Used: fs::File,cli::Cli,file_processing::process_directory,output::write_to_clipboard,output::process_with_template,clap::Parser,validation::validate_cli_args,anyhow::Result,anyhow::Context,io::Write,path::PathBuf,prompt_handling::load_prompts,tokio::main
[/DIRSCRIBE]
*/
use std::fs::File;
mod cli;
